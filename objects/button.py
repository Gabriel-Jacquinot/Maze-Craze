...
class Button: # class that can be accessed to make any new button
    def __init__(self, font, text, bgColour, textColour, x, y, length, width, borderColour, hoverColour, radius): # a placehodlder for all of the parameters associated with making a new button
